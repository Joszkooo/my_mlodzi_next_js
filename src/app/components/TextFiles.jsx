...
export default function TextFiles({ index }){
    ...
    const h2_base_styles = "font-extrabold text-2xl md:text-4xl lg:text-6xl tracking-wide"
    const p_base_styles = "text-wrap text-lg lg:text-xl mt-4"
    if(index === 0){
        return(
            <div className={`${div_base_styles}`}>
                <h2 className={`${h2_base_styles}`}>ROZKWIT</h2>
    ...
    // tutaj poprawic
        ...
        return(
            <div className={`${div_base_styles}`}>
                <h2 className={`${h2_base_styles}`}>ZDOLNI!</h2> 
        ...
        return(
            <div className={`${div_base_styles}`}>
                <h2 className={`${h2_base_styles}`}>ZWARIOWANE BLOKOWISKA</h2>
        ...
        return(
            <div className={`${div_base_styles}`}>
                <h2 className={`${h2_base_styles}`}>AKTYWATOR</h2> 
        ...
        return(
            <div className={`text-black px-6 pb-6 md:px-12 md:pb-12 lg:px-16 lg:pb-16`}>
                <h2 className={`${h2_base_styles}`}>ROZRYWKA</h2>
        ...
        return(
            <div className={`${div_base_styles}`}>
                <h2 className={`${h2_base_styles}`}>INFRASTRUKTURA</h2>
        ...
        return(
            <div className={`${div_base_styles}`}>
                <h2 className={`${h2_base_styles}`}>TWOJE SPRAWY</h2>
